...
/**
 * This is the item provider adapter for a {@link usecase.Actor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActorItemProvider extends PakageableItemProvider {
	/**
	...
	protected void addGeneralPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Actor_general_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Actor_general_feature", "_UI_Actor_type"),
				 UsecasePackage.Literals.ACTOR__GENERAL,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addAllActionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Actor_allActions_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Actor_allActions_feature", "_UI_Actor_type"),
				 UsecasePackage.Literals.ACTOR__ALL_ACTIONS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UsecasePackage.Literals.ACTOR__ACTION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UsecasePackage.Literals.ACTOR__ACTION,
				 UsecaseFactory.eINSTANCE.createAction()));
	}
