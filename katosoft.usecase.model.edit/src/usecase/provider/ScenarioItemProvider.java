...
/**
 * This is the item provider adapter for a {@link usecase.Scenario} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScenarioItemProvider extends StepItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UsecasePackage.Literals.NAMED_ELEMENT__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addLabelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Scenario_label_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Scenario_label_feature", "_UI_Scenario_type"),
				 UsecasePackage.Literals.SCENARIO__LABEL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UsecasePackage.Literals.SCENARIO__STEPS);
			childrenFeatures.add(UsecasePackage.Literals.SCENARIO__GUARD_CONDITION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UsecasePackage.Literals.SCENARIO__STEPS,
				 UsecaseFactory.eINSTANCE.createScenario()));

		newChildDescriptors.add
			(createChildParameter
				(UsecasePackage.Literals.SCENARIO__STEPS,
				 UsecaseFactory.eINSTANCE.createActionStep()));

		newChildDescriptors.add
			(createChildParameter
				(UsecasePackage.Literals.SCENARIO__STEPS,
				 UsecaseFactory.eINSTANCE.createIncludeUseCase()));

		newChildDescriptors.add
			(createChildParameter
				(UsecasePackage.Literals.SCENARIO__STEPS,
				 UsecaseFactory.eINSTANCE.createEndOfUseCase()));

		newChildDescriptors.add
			(createChildParameter
				(UsecasePackage.Literals.SCENARIO__STEPS,
				 UsecaseFactory.eINSTANCE.createExceptionalEnd()));

		newChildDescriptors.add
			(createChildParameter
				(UsecasePackage.Literals.SCENARIO__GUARD_CONDITION,
				 UsecaseFactory.eINSTANCE.createCondition()));
	}
