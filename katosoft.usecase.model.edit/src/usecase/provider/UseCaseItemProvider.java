...
/**
 * This is the item provider adapter for a {@link usecase.UseCase} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UseCaseItemProvider extends PakageableItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UsecasePackage.Literals.USE_CASE__SCENARIO);
			childrenFeatures.add(UsecasePackage.Literals.USE_CASE__PRE_CONDITION);
			childrenFeatures.add(UsecasePackage.Literals.USE_CASE__POST_CONDITION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UsecasePackage.Literals.USE_CASE__SCENARIO,
				 UsecaseFactory.eINSTANCE.createScenario()));

		newChildDescriptors.add
			(createChildParameter
				(UsecasePackage.Literals.USE_CASE__PRE_CONDITION,
				 UsecaseFactory.eINSTANCE.createCondition()));

		newChildDescriptors.add
			(createChildParameter
				(UsecasePackage.Literals.USE_CASE__POST_CONDITION,
				 UsecaseFactory.eINSTANCE.createCondition()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == UsecasePackage.Literals.USE_CASE__PRE_CONDITION ||
			childFeature == UsecasePackage.Literals.USE_CASE__POST_CONDITION;
