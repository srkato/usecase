...
/**
 * This is the item provider adapter for a {@link usecase.Condition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConditionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Condition_text_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Condition_text_feature", "_UI_Condition_type"),
				 UsecasePackage.Literals.CONDITION__TEXT,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Condition.class)) {
			case UsecasePackage.CONDITION__TEXT:
